...
export {
  ADMIN_NOTIFICATION_TYPE as SUPPORT_SYSTEM_NOTIFICATION_TYPE,
  ADMIN_NOTIFICATION_PRIORITY as SUPPORT_SYSTEM_NOTIFICATION_PRIORITY,
  type AdminNotificationType as SupportSystemNotificationType,
  type AdminNotificationPriority as SupportSystemNotificationPriority
};